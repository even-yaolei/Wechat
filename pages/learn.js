...
export default class page extends PureComponent{
    ...
    componentWillMount(){
        document.title=window.title+" - "+"Learn";
    }
    showMenu=()=>{
    ...
    render(){
        const {isMenu}=this.state;
        const goPage=(_tag)=>{
            this.props.history.push("page?t=learn&k="+_tag);
        }
        return (<div className="mod_center" style={{height: "100%"}}>
            <div className="mod_header" data-flex="dir:left cross:center main:justify">
                ...
                <div className="mid_title">Learn</div>
            </div>
            <div className="mod_content" style={{height: "100%"}} data-flex="main:center cross:center">
                <div style={{width: "100%"}}>
                    ...
                    <a onClick={()=>goPage("English")} className="mod_menu" >Learn English</a>
                    <a onClick={()=>goPage("Chinese")} className="mod_menu" >Learn Chinese</a>
                    <a onClick={()=>goPage("Chinese Cuisine")} className="mod_menu" >Learn Cooking(Chinese Cuisine)</a>
                    <a onClick={()=>goPage("Foreign Cuisine")} className="mod_menu" >Learn Cooking(Foreign Cuisine)</a>
                    <a onClick={()=>goPage("Museum")} className="mod_menu"  >Go to Museum</a>
                    <a onClick={()=>goPage("all")} className="mod_menu"  >Learn Anything</a>
                </div>
            </div>
